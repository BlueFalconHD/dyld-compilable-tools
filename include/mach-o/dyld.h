 ...
 */
extern bool _dyld_shared_cache_contains_path(const char* path)/*               __API_AVAILABLE(macos(11.0), ios(14.0), watchos(7.0), tvos(14.0), bridgeosz(5.0)) DYLD_DRIVERKIT_UNAVAILABLE*/;
